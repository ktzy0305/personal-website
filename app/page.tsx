        ...
        <main className="flex flex-row flex-wrap lg:px-20">
            ...
            <div className="flex flex-col px-6 py-12 sm:px-8 lg:px-6 lg:py-12 xl:p-12 lg:w-2/5 lg:sticky lg:top-0 lg:max-h-screen lg:-mt-20 lg:pt-32 xl:pt-32">
                ...
                >
                    ...
                    gaining hands-on experience that extends across various
                    platforms.
                </div>
                <SocialMediaIcons />
            </div>
            ...
            <div className="flex flex-col overflow-y-auto px-6 py-6 sm:px-8 lg:px-6 lg:py-12 xl:p-12 lg:w-3/5">
                ...
                <section id="about">
                    ...
                    <div className="mb-6">
                        Hello there! I’m a sophomore at National University of
                        Singapore immersing myself in the world of Computer
                        Science with a minor in Data Science and Analytics. My
                        passion lies in creating innovative software solutions
                        that contribute to the evolution of our digital
                        landscape.
                    </div>
                </section>
                {/* Experience */}
